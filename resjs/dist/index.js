...
/***/ function(module, exports, __webpack_require__) {
	...
	var _commander = __webpack_require__(76);

	var _commander2 = _interopRequireDefault(_commander);

	var _handlebars = __webpack_require__(77);
	...
	function readMeta(url) {
	    return (0, _axios2.default)(url, { 'Accept': 'application/json' }).then(function (response) {
	...
	function parseResjs() {
	    var filename = (0, _path.join)(__dirname, 'res.base.js');
	    return new _promise2.default(function (resolve, reject) {
	        _fs2.default.readFile(filename, { encoding: 'utf-8' }, function (error, data) {
	            if (error) {
	                reject(error);
	...
	function resjs(url) {
	    ...
	    return _promise2.default.all([parseMeta(url), parseTemplate(), parseResjs()]).then(function (_ref) {
	...
	// cli
	_commander2.default.version('0.0.1').description('generated res.js').arguments('<url> [dest]').option('-p, --prefix [prefix]', 'urlPrefix of generated res.js').action(function (url, dest, options) {
